                    ...
                    <div class="cust-page-content client-detail m-auto pt-5">
                        <div class="page-section mt-3">
                            ...
                            <div class="d-flex mt-3">
                                <div class="col-3">
                                    <p class="m-0 mulish-light font-14 text-gray">N {{ user.id }}</p>
                                </div>
                                <div class="col-9 d-flex px-2">
                                    ...
                                    <div class="col-4"></div>
                                    <div class="col-4">
                                        <p class="m-0 mulish-light font-14 text-gray text-nowrap">Date Création : {{ user.createdAt }}</p>
                                        <p class="m-0 mulish-light font-14 text-gray text-nowrap">Date Modification : {{ user.updatedAt }}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="d-flex mt-3">
