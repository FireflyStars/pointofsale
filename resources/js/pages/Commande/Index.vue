                            ...
                            <div class="col">
                                ...
                                <tab-pane :tabs="tabs" current='tout' class="almarai_700_normal">
                                    ...
                                    <template v-slot:tout>
                                        ...
                                        <item-list-table :table_def="commande" >
...
<script setup>
    ...
    import { COMMANDE_LIST_MODULE } from '../../store/types/types'

    const tabs = ref({})
    const store = useStore()

    const commande = computed(() => store.getters[`${COMMANDE_LIST_MODULE}commandeList`])
