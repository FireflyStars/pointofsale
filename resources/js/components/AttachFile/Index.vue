<template>
    <div class="attach-wrapper">
            ...
            <table class="table table-borderless">
                ...
                <tbody>
                    <tr v-for="(file, index) in files" :key="index">
                        ...
                        <td>{{ file.fileName }}</td>
                        <td>
                            <svg width="14" @click="viewFile" height="16" viewBox="0 0 14 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <span class="mx-2 download-icon" @click="downloadFile"></span>
                            <svg width="24" @click="removeDocument(index)" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div class="attach-footer lcdtOrange">
            <span class="me-3 plus-icon" @click="openFileDialog"></span> AJOUTER
        </div>    
        <input type="file" @change="addToDocumentList" accept="audio/*,video/*,image/*" ref="document" multiple class="d-none">
    </div>
</template>
<script>
    import { ref } from 'vue';
    ...
    export default {
        ...
        setup(props, { emit }){
            ...
            const addToDocumentList = ()=>{
                let documents = file.value.files;
                for (let i = 0; i < documents.length; i++) {
                    let type = documents[i].type.split("/")[0];
                    if(type == 'image'){
                        type = 'png';
                    }else if(type == 'audio'){
                        type = 'm4a';
