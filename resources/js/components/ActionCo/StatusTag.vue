...
const order_states = computed(() => store.getters[`${ACTION_COMMERCIAL_STATUS_MODULE}orderStates`])
const loaded = computed(() => store.getters[`${ACTION_COMMERCIAL_STATUS_MODULE}loaded`])
