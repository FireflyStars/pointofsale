...
//HTML TEMPLATE
export const HTMLTEMPLATE_MODULE='HTMLTEMPLATE_MODULE/';//namespace
export const HTMLTEMPLATE_GET_GLOBALCONF='HTMLTEMPLATE_GET_GLOBALCONF';//getter
export const HTMLTEMPLATE_SET_GLOBALCONF='HTMLTEMPLATE_SET_GLOBALCONF';//mutation
export const HTMLTEMPLATE_LOAD_GLOBALCONF='HTMLTEMPLATE_LOAD_GLOBALCONF';//action
export const HTMLTEMPLATE_SAVE_GLOBALCONF='HTMLTEMPLATE_SAVE_GLOBALCONF';//action
export const HTMLTEMPLATE_GET_ID='HTMLTEMPLATE_GET_ID'//mutation
export const HTMLTEMPLATE_SET_ID='HTMLTEMPLATE_SET_ID'//mutation
export const HTMLTEMPLATE_SAVE_ELEMENT='HTMLTEMPLATE_SAVE_ELEMENT'//action
export const HTMLTEMPLATE_LOAD_ELEMENTS='HTMLTEMPLATE_LOAD_ELEMENTS'//action
export const HTMLTEMPLATE_SET_ELEMENTS='HTMLTEMPLATE_SET_ELEMENTS'//mutations
export const HTMLTEMPLATE_GET_ELEMENTS='HTMLTEMPLATE_GET_ELEMENTS'//getter
export const HTMLTEMPLATE_REMOVE_ELEMENT='HTMLTEMPLATE_REMOVE_ELEMENT'//action
export const HTMLTEMPLATE_UNSET_ELEMENT='HTMLTEMPLATE_UNSET_ELEMENT'//mutation
export const HTMLTEMPLATE_REPOSITION_ELEMENT='HTMLTEMPLATE_REPOSITION_ELEMENT'//action
export const HTMLTEMPLATE_SET_RENDERSQL='HTMLTEMPLATE_SET_RENDERSQL'//mutation
export const HTMLTEMPLATE_SET_HEADERLIST='HTMLTEMPLATE_SET_HEADERLIST'//mutation
export const HTMLTEMPLATE_SET_FOOTERLIST='HTMLTEMPLATE_SET_FOOTERLIST'//mutation
export const HTMLTEMPLATE_GET_FOOTERLIST='HTMLTEMPLATE_GET_FOOTERLIST'//getter
export const HTMLTEMPLATE_GET_HEADERLIST='HTMLTEMPLATE_GET_HEADERLIST'//getter
export const HTMLTEMPLATE_SET_CURRENTHEADER='HTMLTEMPLATE_SET_CURRENTHEADER'//mutation
export const HTMLTEMPLATE_SET_CURRENTFOOTER='HTMLTEMPLATE_SET_CURRENTFOOTER'//mutation
export const HTMLTEMPLATE_GET_CURRENTHEADER='HTMLTEMPLATE_GET_CURRENTHEADER'//getter
export const HTMLTEMPLATE_GET_CURRENTFOOTER='HTMLTEMPLATE_GET_CURRENTFOOTER'//getter
export const HTMLTEMPLATE_SAVE_HF='HTMLTEMPLATE_SAVE_HF'//action
export const HTMLTEMPLATE_TEST_EMAIL='HTMLTEMPLATE_TEST_EMAIL'//action
export const HTMLTEMPLATE_GET_GLOBAL_CSS='HTMLTEMPLATE_GET_GLOBAL_CSS'//getter
export const HTMLTEMPLATE_SET_GLOBAL_CSS='HTMLTEMPLATE_SET_GLOBAL_CSS'//mutation
export const HTMLTEMPLATE_SAVE_GLOBAL_CSS='HTMLTEMPLATE_SAVE_GLOBAL_CSS'//action
export const HTMLTEMPLATE_RESET_STATE='HTMLTEMPLATE_RESET_STATE'//mutation3

//HTML TEMPLATE LIST
export const HTMLTEMPLATELIST_MODULE='HTMLTEMPLATELIST_MODULE/';//namespace
export const HTMLTEMPLATELIST_LOAD_TAB='HTMLTEMPLATELIST_LOAD_TAB'//action
export const HTMLTEMPLATELIST_LIST_DEF='HTMLTEMPLATELIST_LIST_DEF'//getter
export const HTMLTEMPLATELIST_DELETE_ROW='HTMLTEMPLATELIST_DELETE_ROW'//action
export const HTMLTEMPLATELIST_DUPLICATE_ROW='HTMLTEMPLATELIST_DUPLICATE_ROW'//action
//HTML TEMPLATE HEADER LIST
export const HTMLTEMPLATEHEADERLIST_MODULE='HTMLTEMPLATEHEADERLIST_MODULE/';//namespace
export const HTMLTEMPLATEHEADERLIST_LOAD_TAB='HTMLTEMPLATEHEADERLIST_LOAD_TAB'//action
export const HTMLTEMPLATEHEADERLIST_LIST_DEF='HTMLTEMPLATEHEADERLIST_LIST_DEF'//getter

//HTML TEMPLATE FOOTER LIST
export const HTMLTEMPLATEFOOTERLIST_MODULE='HTMLTEMPLATEFOOTERLIST_MODULE/';//namespace
export const HTMLTEMPLATEFOOTERLIST_LOAD_TAB='HTMLTEMPLATEFOOTERLIST_LOAD_TAB'//action
export const HTMLTEMPLATEFOOTERLIST_LIST_DEF='HTMLTEMPLATEFOOTERLIST_LIST_DEF'//getter
...
export const FOURNISSEUR_SEARCH_LOAD_LIST = 'FOURNISSEUR_SEARCH_LOAD_LIST'
export const FOURNISSEUR_SET_SEARCH_LIST = 'FOURNISSEUR_SET_SEARCH_LIST'
export const FOURNISSEUR_SET_SEARCH_COUNT = 'FOURNISSEUR_SET_SEARCH_COUNT'
export const CREATE_NEW_COMMANDE_FOURNISSEUR = 'CREATE_NEW_COMMANDE_FOURNISSEUR'
export const ARCHIVE_FOURNISSEUR = 'ARCHIVE_FOURNISSEUR'      
...
export const COMMANDE_FOURNISSEUR_LIST_MODULE = 'COMMANDE_FOURNISSEUR_LIST_MODULE/'
export const COMMANDE_FOURNISSEUR_GET_LIST = 'COMMANDE_FOURNISSEUR_GET_LIST'
export const COMMANDE_FOURNISSEUR_GET_LIST_MES = 'COMMANDE_FOURNISSEUR_GET_LIST_MES'
export const COMMANDE_FOURNISSEUR_LOAD_ORDER_DETAILS = 'COMMANDE_FOURNISSEUR_LOAD_ORDER_DETAILS'
export const COMMMANDE_FOURNISSEUR_SAVE_DETAILS = 'COMMMANDE_FOURNISSEUR_SAVE_DETAILS'
export const COMMMANDE_FOURNISSEUR_SAVE_SUPPLIER_ORDER = 'COMMMANDE_FOURNISSEUR_SAVE_SUPPLIER_ORDER'
export const COMMANDE_FOURNISSEUR_GET_SUPPLIER_ORDER = 'COMMANDE_FOURNISSEUR_GET_SUPPLIER_ORDER'
export const FOURNISSEUR_SEARCH_PRODUCTS = 'FOURNISSEUR_SEARCH_PRODUCTS'
export const FOURNISSEUR_SET_PRODUCTS = 'FOURNISSEUR_SET_PRODUCTS'
export const FOURNISSEUR_SET_PRODUCT_SEARCH_COUNT = 'FOURNISSEUR_SET_PRODUCT_SEARCH_COUNT'
export const GET_PRODUCT_UNITS = 'GET_PRODUCT_UNITS'
export const SET_PRODUCT_UNITS = 'SET_PRODUCT_UNITS'
export const FOURNISSEUR_COMMANDE_CREATE_SUPPLIER_ORDER = 'FOURNISSEUR_COMMANDE_CREATE_SUPPLIER_ORDER'
export const SAVE_SUPPLIER_ORDER = 'SAVE_SUPPLIER_ORDER'

export const COMMANDE_FOURNISSEUR_STATUS_MODULE = 'COMMANDE_FOURNISSEUR_STATUS_MODULE/'

// Chat
export const CHAT_MODULE = 'CHAT_MODULE/'
export const LOAD_USER_MESSAGE = 'LOAD_USER_MESSAGE'
export const LOAD_MORE_USER_MESSAGE = 'LOAD_MORE_USER_MESSAGE'
export const SELECT_USER = 'SELECT_USER'
export const GET_SELECTED_USERINFO = 'GET_SELECTED_USERINFO'
export const GET_USERS = 'GET_USERS'
export const GET_USER_MESSAGE = 'GET_USER_MESSAGE'
export const SET_USER_MESSAGE = 'SET_USER_MESSAGE'

//invoice search
export const INVOICELIST_MODULE = 'INVOICELIST_MODULE/'
export const INVOICE_SEARCH_LOAD_LIST = 'INVOICE_SEARCH_LOAD_LIST'
export const INVOICE_SET_SEARCH_LIST = 'INVOICE_SET_SEARCH_LIST'
export const INVOICE_GET_SEARCH_LIST = 'INVOICE_GET_SEARCH_LIST'
export const INVOICE_SET_SEARCH_COUNT = 'INVOICE_SET_SEARCH_COUNT'
export const INVOICE_GET_SEARCH_COUNT = 'INVOICE_GET_SEARCH_COUNT'
export const INVOICE_SET_LOADER = 'INVOICE_SET_LOADER'
...
export const CREATE_LIGNE = 'CREATE_LIGNE'
export const UPDATE_LIGNE = 'UPDATE_LIGNE'
export const DELETE_LIGNE = 'DELETE_LIGNE'

export const PRODUCT_MODULE = 'PRODUCT_MODULE/'
