...
class DevisController extends Controller
{
    ...
    public function getDevis($devisId){
        ...
        $zones = DB::table('order_zones')
                    ...
                    ->get();
        $devis = [];
        $devis['orderStatus'] = DB::table('orders')->join('order_states', 'order.order_state_id', '=', 'order_states.id')->select('order_states.order_type as type', 'name', 'fontcolor', 'color')->first();
