    ...
    public function edit(Contact $contact){
        ...
        return response()->json([
            'contact'=>[
                ...
                'active'    => $contact->actif == 1 ? true : false,
                ...
                'acceptSMS' => $contact->acceptsms == 1 ? true : false,
                'acceptmarketing' => $contact->acceptmarketing == 1 ? true : false,
                'acceptcourrier' => $contact->acceptcourrier == 1 ? true : false,
                'customer'  => [
